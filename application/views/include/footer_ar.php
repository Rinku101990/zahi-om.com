    ...
    <!-- FOOTER -->
        <footer id="footer" class="footer">
            <div class="footer-top">
                <div class="container">
                    <div class="row cols-xs-space cols-sm-space cols-md-space" dir="rtl">
                            ...
                            <div class="text-center text-md-right">
                                ...
                                foreach( array_chunk(get_category(),7)[0] as $vmnal){
                                   ...
                                   <li><a href="<?=base_url('category/').encode($vmnal->cate_id).'/'.$vmnal->cate_slug;?>" title="<?=$vmnal->cate_name;?>">
                                    <i class="fa fa-angle-double-left"></i> <?=$vmnal->cate_name_ar;?>   </a>
                                    </li>
                                <?php }}?>
                        ...
                        <div class="col-lg-2 col-md-4">
                            <div class="text-center text-md-right">
                                <ul class="footer-links">
                                    <?php if(@array_chunk(get_category(),7)[1]==TRUE){
                                foreach(@array_chunk(get_category(),7)[1] as $vmnal1){
                                   ...
                                   <li><a href="<?=base_url('make-your-own-design');?>" title="<?=$vmnal1->cate_name;?>">
                                    <i class="fa fa-angle-double-right"></i> <?=$vmnal1->cate_name_ar;?>   </a>
                                    </li>
                                <?php }else{?>
                        ...
                        <div class="col-lg-2 col-md-4">
                            <div class="text-center text-md-right">
                                ...
                                <ul class="footer-links">
                                   <li><a href="<?=base_url('about-us');?>" title="International Shipping">
                                     <i class="fa fa-angle-double-left"></i><?=lang_ar(32);?> </a>
                                    </li>
                                    <li><a href="<?=base_url('sales-contract');?>" title="Sales Contract">
                                      <i class="fa fa-angle-double-left"></i><?=lang_ar(31);?> </a>
                                    </li>
                                   
                                    <!-- <li><a href="#" title="Career">
                                    <i class="fa fa-angle-double-left"></i> Career</a>
                                    </li> 
                                    <li><a href="<?=base_url('tracking-order');?>" title="Tracking Order">
                                    <i class="fa fa-angle-double-left"></i><?=lang_ar(33);?> </a>
                                    </li>-->
                                    <li><a href="<?=base_url('return-policy');?>" title="Privacy Policy">
                                    <i class="fa fa-angle-double-left"></i><?=lang_ar(34);?> </a>
                                    </li>
                                    <li><a href="<?=base_url('privacy-policy');?>" title="Privacy Policy">
                                    <i class="fa fa-angle-double-left"></i><?=lang_ar(35);?> </a>
                                    </li>
                                    <li><a href="<?=base_url('term-and-conditions');?>" title="Term of Use">
                                   <i class="fa fa-angle-double-left"></i><?=lang_ar(36);?> </a>
                                    </li>
                                    <li><a href="<?=base_url('faq');?>" title="faq">
                                   <i class="fa fa-angle-double-left"></i><?=lang_ar(69);?> </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="text-center text-md-right">
                                ...
                                <ul class="footer-links">
                                    <li><a href="<?=base_url('seller');?>" title="Vendor Registration ">
                                      <i class="fa fa-angle-double-left"></i> <?=lang_ar(70);?> </a>
                                    </li>
                                    ...
                                    <li><a href="javascript:void(0);" class="SignUp_Model" title="Register New Account">
                                     <i class="fa fa-angle-double-left"></i> <?=lang_ar(37);?>  </a>
                                    </li>
                                ...
                                <?php }?>
                                    ...
                                    <li><a href="<?=base_url('account/my-profile');?>" title="My Profile">
                                      <i class="fa fa-angle-double-left"></i> <?=lang_ar(38);?> </a>
                                    </li>
                                    <li><a href="<?=base_url('account/my-order');?>" title="My Order">
                                     <i class="fa fa-angle-double-left"></i> <?=lang_ar(39);?> </a>
                                    </li>
                                    <li><a href="<?=base_url('account/shipping-address');?>" title="Shipping Address">
                                   <i class="fa fa-angle-double-left"></i> <?=lang_ar(40);?> </a>
                                    </li>
                                    <li><a href="<?=base_url('account/change-password');?>" title="Change Password">
                                      <i class="fa fa-angle-double-left"></i> <?=lang_ar(10);?> </a>
                                    </li>
                                    
                                    <li><a href="<?=base_url('cart');?>" title="Update Cart">
                                    <i class="fa fa-angle-double-left"></i> <?=lang_ar(41);?></a>
                                    </li>
                                   <!-- <li><a href="<?=base_url('account/logout');?>" title="Logout">-->
                                   <!--<i class="fa fa-angle-double-left"></i> <?=lang_ar(42);?> </a>-->
                                   <!-- </li>-->
                                </ul>
                            </div>
                        </div>
                         <div class="col-lg-2 col-md-4">
                            <div class="text-center text-md-right">
                               ...
                               <!--<p style="margin-bottom: 5px;"><a href="https://www.facebook.com/" target="_blank"><i class="fa fa-facebook"></i> <?=lang_ar(75);?></a></p>-->
                                <p style="margin-bottom: 5px;"><a href="https://instagram.com/zahi.fashion/" target="_blank"><i class="fa fa-instagram"></i> <?=lang_ar(76);?> </a></p>
                        ...
                        <div class="col-lg-2 col-md-4">
                            <div class="text-center text-md-right">
                                ...
                                <ul class="footer-links">
                                   <li><a href="https://apps.apple.com/in/app/zahi/id1567058098" target="blank">
            ...
            <div class="footer-bottom sct-color-3" style="/*background: #c19450;*/background-image: url('<?=base_url();?>assets/img/Footer-Pallet-1.jpg'); padding: 30px 0;background-size: cover;">
                <div class="container">
                    ...
                    <ul class="footerulli" align="center">
                         <li><a href="#" dir="rtl"><i class="fa fa-envelope"></i> <?=lang_ar(80);?>: zahi-om.com</a></li>
                         <li><a href="#" dir="rtl"><i class="fa fa-mobile"></i> <?=lang_ar(79);?>: <?=$this->website->web_support_contact;?></a></li>
                         <li><a href="#" dir="rtl"><i class="fa fa-wechat"></i> <?=lang_ar(78);?></a></li>
                          
                          <!--<li><a href="#" dir="rtl"><i class="fa fa-skype"></i> <?=lang_ar(94);?></a></li>-->
                          
                          
                        <li><a href="#" dir="rtl"><i class="fa fa-phone"></i> <?=lang_ar(93);?> :<?=$this->website->web_support_contact;?></a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <p align="center" style="color: #fff;font-size: 15px;">احصل على أحدث تحديثات الأسلوب</p>
                        </div>
                    </div>
                     <div class="row">
   ...
   ">
                                    <form class="form-inline" method="POST" action="<?=base_url('subscribers');?>">
                                        ...
                                        <div class="form-group mb-0" style="width: 85.5%;">
                                            <input type="email" class="form-control" placeholder="<?=lang_ar(45);?>" name="email" required="" dir="rtl" style="
    width: 100%;border-right: none;text-align: right">
                                        </div>
...
//             method:"POST",
//             //dataType:"JSON",
//             data:{brand:brand,color:color,size:size,price:price,grade:grade,condition:condition,category:category,sub_category:sub_category,child_category:child_category,hot:hot,featured:featured,trending:trending,eid:eid,supplier:supplier,newest_first:newest_first,p_name:p_name,p_brand:p_brand,p_cate:p_cate,p_scate:p_scate,p_child:p_child},
