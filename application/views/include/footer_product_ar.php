            ...
            <div class="footer-bottom sct-color-3" style="/*background: #c19450;*/background-image: url('<?=base_url();?>assets/img/Footer-Pallet-1.jpg'); padding: 30px 0;background-size: cover;">
                <div class="container">
                    ...
                    <ul class="footerulli" align="center">
                         <li><a href="#" dir="rtl"><i class="fa fa-envelope"></i> Email: zahi-om.com</a></li>
                         <li><a href="#" dir="rtl"><i class="fa fa-mobile"></i> SMS: <?=$this->website->web_support_contact;?></a></li>
                         <li><a href="#" dir="rtl"><i class="fa fa-wechat"></i> Online Chat</a></li>
                          
                          <!--<li><a href="#" dir="rtl"><i class="fa fa-skype"></i> skype.account</a></li>-->
                          
                          
                        <li><a href="#" dir="rtl"><i class="fa fa-phone"></i> Sales :<?=$this->website->web_support_contact;?></a></li>
