                    ...
                    <form action="javascript:void(0)" class="form-default" data-toggle="validator" role="form" method="POST" id="checkout-form">
                        ...
                        <div class="row align-items-center pt-4">
                            ...
                            <div class="col-6 text-right">
                                <button type="button" onclick="placeOrder()" class="btn btn-styled btn-base-1">CONFIRM ORDER</button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="card sticky-top">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table-cart table-cart-review">
                                ...
                                <?php }else if(delivery_ct_charge($Address->cnt_id)->min_amount >=$gttotal){?>
                                     <tr class="cart-shipping">
                                    ...
                                    <tr class="cart-total">
                                        ...
                                        <td class="text-right">
                                            <strong>
                                                <span>
                                                    <?=currency($this->website->web_currency);?>
                                                    <span class="CartTotalAmount" total="<?=$total+$gst_total;?>"><?php if(!empty($this->cart->contents())){echo $this->cart->format_number($total+$gst_total+$dl_charges);}?></span>
                                                </span>
                                            </strong>
                                        </td>
                                    </tr>
