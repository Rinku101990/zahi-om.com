    ...
    <div class="container">
        <div class="row cols-xs-space cols-sm-space cols-md-space">
         ...
         <td style="padding: 18px 6px" class="cancel<?=encode($row->pro_id);?>" >
            ...
            <a title="Cancel this item" class="cancel-item CancelItem" href="javascript:void(0);" style="color: #ca1212;"  pid="<?=encode($row->pro_id);?>" vndid="<?=encode($row->ord_vendors);?>"><i class="fa fa-times-circle"> Cancel</i></a>
        <?php }?>
