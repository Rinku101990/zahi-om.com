                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    <tr>
                      ...
                      <td style="padding: 5px;text-align: left;border: 1px solid #d5d2d2;"><?=$pro->pro_color;?></td>
                											...
                											<td style="padding: 5px;text-align: left;border: 1px solid #d5d2d2;">OMR<?=number_format($pro->pro_price,2);?></td>
                											
                											<td style="padding: 5px;text-align: left;border: 1px solid #d5d2d2;">OMR<?php echo number_format($pro->pro_qty*$pro->pro_price,2);?></td>
                										</tr>
                										<?php }?>
                                     <tr>
                      <td colspan="5"></td>
