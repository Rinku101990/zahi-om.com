          ...
          <div class="content" style="box-sizing: border-box; display: block; Margin: 0 auto; max-width: 580px; padding: 10px;">
            ...
            <table class="main" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; background: #ffffff; border-radius: 3px;">
              ...
              <tr>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    <tr>
                      ...
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Hi Zahi Team : New Order Received.</p>
                ...
                <th style="padding: 5px;text-align: left;border: 1px solid #d5d2d2;">Img</th>
                <th style="padding: 5px;text-align: left;border: 1px solid #d5d2d2;">Sleeve</th>
                <th style="padding: 5px;text-align: left;border: 1px solid #d5d2d2;">Fabric</th>
                ...
                <td style="padding: 5px;text-align: left;border: 1px solid #d5d2d2;"><img src="<?=$pro->sl_img;?>" style="object-fit: cover;height: 57px;width:100%" /></td>
                <td style="padding: 5px;text-align: left;border: 1px solid #d5d2d2;"><?=$pro->sl_name?></td>
                <td style="padding: 5px;text-align: left;border: 1px solid #d5d2d2;"><img src="<?=$pro->fb_img;?>" style="object-fit: cover;height: 57px;width:100%" /></td>
                <td style="padding: 5px;text-align: left;border: 1px solid #d5d2d2;"><img src="<?=$pro->cl_img;?>" style="object-fit: cover;height: 57px;width:100%" /></td>
                 <td style="padding: 5px;text-align: left;border: 1px solid #d5d2d2;"><p style=" font-size: 12px;font-weight: 600;">
                    Shoulder :  <?=$pro->shoulder;?> Inch<br/>
                    Bust :  <?=$pro->bust;?> Inch<br/>
                    Waist :  <?=$pro->waist;?> Inch<br/>
                    Hips :  <?=$pro->hips;?> Inch<br/>
                    Length :  <?=$pro->length;?> Inch</p></td>
                										
                <td style="padding: 5px;text-align: left;border: 1px solid #d5d2d2;"><?=$pro->qty?></td>
                <td style="padding: 5px;text-align: left;border: 1px solid #d5d2d2;">OMR<?=number_format($pro->sl_price,2);?></td>                
                <td style="padding: 5px;text-align: left;border: 1px solid #d5d2d2;">OMR<?php echo number_format($pro->qty*$pro->sl_price,2);?></td>
                										</tr>
                										<?php }?>
                                     <tr>
                      <td colspan="7"></td>
            							...
            							<tbody>
            								<tr>
            									<td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;">
            										...
            										<p><strong>Shipping Address</strong>: <?=$cmpt_ord_detail->shippingAddress?>, <?=$cmpt_ord_detail->City?> <?=$cmpt_ord_detail->Zip?>, <?=$cmpt_ord_detail->State?>, <?=$cmpt_ord_detail->Country?>
            									<td>
            								</tr>
            							</tbody>
            						</table>

                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">	If you have any issues, feel free to contact us at care@zahi.com</p>
              ...
              <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                <tr>
                  <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                   <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">C-71 sector -19 Noida UP - 201301</span>
