...
<head>
	...
	<script>
        window.fbAsyncInit = function() {
            ...
            FB.init({
              appId      : '413736386572248', // FB App ID
              cookie     : true,  // enable cookies to allow the server to access the session
              xfbml      : true,  // parse social plugins on this page
              version    : 'v9.0' // use graph api version 2.10
            });
        ...
        function fbLogout() {
            FB.logout(function() {
                ...
                document.getElementById('fbLink').innerHTML = '<img src="<?php echo base_url('assets/images/facebook_login_button1.png'); ?>" style="width:15%"/>';
...
<a href="javascript:void(0);" onclick="fbLogin();" id="fbLink"><img src="<?php echo base_url('assets/images/facebook_login_button1.png'); ?>" style="width:15%"/></a>
