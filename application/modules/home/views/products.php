...
<!--<div class="breadcrumb-area mt-10" style=" background-size: 100%; width: 100%; background-image: url('https://zahi-om.com/assets/img/ae4.gif'); height: 61px; padding: 0;">-->
        <div class="breadcrumb-area mt-10" style="background-image: url('https://zahi-om.com/assets/img/header-pallet.jpg');margin-top: 117px !important;">
        <div class="container" >
            <div class="row" style="direction:<?=$direction;?>">
               <div class="col-md-6 col-sm-6">
                    <h1 class="text-uppercase pull-<?=$floatl;?>" style="font-size: 1.5rem;"><?=$category;?></h1>
                </div>
                <div class="col-md-6 col-sm-6 hidden">
                    <ul class="breadcrumb pull-<?=$floatr;?>">
                        <li><a href="<?=base_url();?>"><?=$home;?></a></li>
                        <li><a href="#"><?=$mcategory;?></a></li>
                         <li class="active"><a href="#"><?=$scategory;?></a></li>
                                                                                            </ul>
                </div>
            </div>
        </div>
...
<div class="bg-white sidebar-box mb-3">
                                ...
                                <ul style="padding: 10px 10px 0px 10px;margin-bottom: 12px;">
                                     <?php if(!empty($p_category)){
                                      if(sub_category($p_category)==true){
                                        ...
                                        <li><a href="javascript:void(0);" class="scate_categorie <?php if($smenu_val->scate_id==@$p_scategory)echo'active';?> " scate="<?=encode($smenu_val->scate_id);?>"><i class="fa fa-angle-right "></i> &nbsp;<?php   if($this->website->web_lang=='en'){echo $smenu_val->scate_name;}else{echo $smenu_val->scate_name_ar;}?></a>
                        ...
                        foreach (child_category($smenu_val->scate_id) as $ch_menuval) {?> 
                                        <li><a href="<?=base_url('child-category/').encode($ch_menuval->child_id).'/'.$ch_menuval->child_slug;?>" class="child_categorie <?php if($ch_menuval->child_id==@$p_chcategory)echo'active';?>"><i class="fa fa-circle"></i> &nbsp;<?php  if($this->website->web_lang=='en'){echo $ch_menuval->child_name;}else{echo $ch_menuval->child_name_ar;}?> </a></li>
                                      <?php }}?>
                                       </ul>
                                        </li>
                                          <?php }}}?>
                                    ...
                                    <div class="box-content overflow-auto ">
                                        ...
                                        <div class="filter-checkbox"> 
                                          <?php foreach (seller() as $brd_value) {?>
                                                        ...
                                                        <label for="attribute_2_value_34"><?php if($this->website->web_lang=='en'){ echo $brd_value->vnd_name;}else{ if(!empty($brd_value->vnd_name_ar)){echo $brd_value->vnd_name_ar;}else{echo $brd_value->vnd_name;}}?></label>
                                                    </div> 
                                                  <?php }?>
...
<!--                                </div>-->
                  ...
                  <div class="slick-carousel" data-slick-arrows="true" data-slick-dots="FALSE" data-slick-autoplay="true">
                     ...
                     <!--   <img src="<?php echo site_url('uploads/');?>banners/aya-jewels-latest.jpg" alt="Orsa" class="img-responsive" style="width:100%;object-fit: contain;padding: 0" />-->
                     <!--</div>-->
                      <div class="" style="height:454px !important;">
                     ...
                     <!-- <div class="" style="height:454px !important;">-->
                     <!--   <img src="<?php echo site_url('uploads/');?>banners/manar-latest.jpg" alt="Orsa" class="img-responsive" style="width:100%;object-fit: contain;padding: 0" />-->
                     <!--</div>-->
                     <!-- <div class="" style="height:454px !important;">-->
                     <!--   <img src="<?php echo site_url('uploads/');?>banners/mothers-day-latest-colllections.jpg" alt="Orsa" class="img-responsive" style="width:100%;object-fit: contain;padding: 0" />-->
                     <!--</div>-->
                     <!--  <div class="" style="height:454px !important;">-->
