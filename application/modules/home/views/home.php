                        ...
                        <div class="clearfix">
                         ...
                         <div class="price-box float-<?=$floatl;?>">
                           <del class="old-product-price strong-400"><?=currency($this->website->web_currency);?><?=$hot_list->p_selling_price;?></del><br/>
                                <span class="product-price strong-600">
                                                      <?=currency($this->website->web_currency);?><?=$hot_list->sp_special_price;?>
                                                    </span>
                               </div>
                                <?php }else{?>
                                 <div class="price-box float-<?=$floatl;?>" >                           
   ...
   <div class="container">
      <div class="px-2 py-4 p-md-4 bg-white shadow-sm">
         ...
         <div class="section-title-1 clearfix ">
          ...
          <!--   <ul class="inline-links float-right">
               <li><a href="<?php echo base_url('child-category/MTE4/Black-Abaya');?>" class="active"><?=$view_more;?></a></li>
            </ul> -->
...
<!--         <div class="col-lg-12">-->
<!--            <div class="media-banner mb-3 mb-lg-0">-->
<!--               <a href="<?=base_url('make-your-own-design');?>" class="banner-container">-->
<!--               <img src="<?php echo site_url('assets/');?>images/placeholder-rect.jpg" data-src="<?php echo site_url('uploads/');?>banners/Group-29.jpg" alt="Active eCommerce promo" class="img-fluid lazyload">-->
<!--               </a>-->
<!--            </div>-->
<!--         </div>-->
