    ...
    <section class="product-details-area ">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="product-gal sticky-top d-flex flex-row-reverse">
                            <div class="product-gal-img">
                                ...
                                <img src="<?=base_url('seller/uploads/').slug($products->cate_name).'/'.slug($products->scate_name).'/'.slug($products->child_name).'/zoom/'.$img;?>" class="xzoom img-fluid lazyloaded" data-src="<?=base_url('seller/uploads/').slug($products->cate_name).'/'.slug($products->scate_name).'/'.slug($products->child_name).'/zoom/'.$img;?>" alt="<?=$productName;?>" xoriginal="<?=base_url('seller/uploads/').slug($products->cate_name).'/'.slug($products->scate_name).'/'.slug($products->child_name).'/zoom/'.$img;?>" style="width: 100%;height: 500px;object-fit: contain;">
                                <?php }else{?>
                            ...
                            <div class="product-gal-thumb">
                                <div class="xzoom-thumbs">
                                    ...
                                    <a href="<?=base_url('seller/uploads/default-image.png');?>">
                                        <img src="<?=base_url('seller/uploads/default-image.png');?>" alt="<?=$productName;?>"  class="xzoom-gallery lazyloaded <?php if(@$key==0)echo'xactive';?>" width="80" data-src="<?=base_url('seller/uploads/default-image.png');?>" xpreview="<?=base_url('seller/uploads/default-image.png');?>">
                                    </a>
                                    <?php }?>
                                </div>
                            </div>
       ...
       <input type="hidden" name="intid" value="<?php if(!empty(inventory_color($products->p_id))){echo inventory_color($products->p_id)[0]->int_id;}?>">
                            ...
                            foreach(explode(', ',$products->p_option_group) as $option_group){
                              ?>
                               <!-- start Color -->
                               <?php   $get_option_color=inventory_color($products->p_id);  
                               if($option_group=='1' && option($option_group)->opt_display=='1' && !empty($get_option_color) && !empty($get_option_color[0]->int_color)){?>
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-10">
                                        <ul class="list-inline checkbox-color mb-1">
                                            ...
                                            foreach ($get_option_color as $key=>$opt_value){?>
                                            <li>
                              ...
                              <?php }?>
                                <!-- end  Color -->
                                  <!-- start Color -->
                               <?php  
                               if($option_group=='3' && option($option_group)->opt_display=='1'){?>
                                 <!-- start  Dimensions -->
                                  <div class="row no-gutters">
                                       <div class="col-2">
                                  ...
                                  <!-- start  size -->
                                     <?php $get_option_size=inventory_size($products->p_id);               
                                     if($option_group!='1' && !empty($get_option_size)){?>
                                 ...
                                 <div class="col-10">
                                          ...
                                          <select class="form-control custom-select mt-1 color_size custom_abaya" onchange="abaya_size(this)" name="abaya_choice" pid="<?=$products->p_id;?>">
                                      
                                                        <option value="">Select <?php if(option($option_group)->opt_name!='Abaya Length'){
                                                echo option($option_group)->opt_name;
                                              }else{echo'Size';}?></option>
                                                        <?php if($products->int_custom=='1'){?>
                                                        <option value="custom" is_custom="1" >Custom</option>
                                                         <?php } //$get_option=explode(',',option($option_group)->opt_value);                               
                                                foreach ($get_option_size as $opt_value){
                                                   if(!empty($opt_value->int_size)){?>
                                                  <option value="<?=$opt_value->int_size;?>" is_custom="" show_regular_size="1"><?=$opt_value->int_size;?> <?php if($option_group=='5'){ echo "''";}?></option>       <?php }}?></select>
                                           
                                            <span id="sizeError"></span>
                                        </div>
                                      </div>
                                       <div class="col-12 " id="normal_size" style="display: none; padding-left: 0px; padding-top: 20px;padding-right: 0px; ">
                                          <select class="form-control custom-select mt-1 Custom_size" id="abaya_size" name="regular_size">
                                             <option value="" selected="">Select Size</option>  
                                           </select>
                                        </div>
                                        <div class="col-12 " id="custom_size" style="display: none; padding-left: 0px; padding-top: 20px; padding-right: 0px; ">
                                           <div class="row">
                                           ...
                                           <div class="col-xl-4 col-lg-3 col-sm-4 col-6">
                                             ...
                                             <div class="col-xl-4 col-lg-3 col-sm-4 col-6">
                                            <!--   <label>Sleevs Width</label> -->
                                               <label>Bust</label>
                                             <!--  <input type="number" class="form-control" id="sleevs_width" placeholder="Inch"  > -->
                                        ...
                                        <div class="col-10">
                                            <div class="product-quantity d-flex align-items-center">
                                                <div class="input-group input-group--style-2 pr-3" style="width: 160px;">
                                                    ...
                                                    <input type="text" name="quantity" class="form-control input-number text-center avail_qty" data-field="quantity" placeholder="1" value="1" max='<?=$products->int_available_qty;?>' min="<?=$products->int_min_purchase_qty;?>" disabled>
                                                    <span class="input-group-btn">
                                    ...
                                    <ul class="nav nav-tabs justify-content-left sticky-top bg-white" style="">
                                       ...
                                       <!--  <li class="nav-item">
                                        ...
                                        //if(!empty($products->p_return_policy)){
                                          ?>
                                        <li class="nav-item">
                                            <a href="#tab_default_3" data-toggle="tab" class="nav-link text-uppercase strong-600">RETURN & REFUND POLICY</a>
                                        </li>
                                        <?php // }?>
                                        <li class="nav-item">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <br>
                                                          <?php if($products->scate_slug=='Abaya' || $products->scate_slug=='Caftan' || $products->scate_slug=='Dress' || $products->scate_slug=='Jalabiya'){?>
                                                        <p><b>Size Guide :</b></p>
                                                        <img src="<?=base_url('assets/img/Measurement.jpg');?>" alt="<?=$productName;?>"  class="img-responsive"  />
                                                        <?php }?>
                                                    </div>
                                                </div>
   ...
   <div class="modal-dialog modal-sm modal-dialog-zoom" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body" style="padding: 0 1px;">
            <img src="<?=base_url('assets/img/Measurement.jpg');?>" class="img-responsive" />
         </div>
      </div>
   </div>
</div>