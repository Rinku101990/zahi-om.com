...
<html>
   <head>
     ...
     <meta name="google-site-verification" content="hdvlk2Z0OY_6QMZj3R1vzWHynhllVTyF0RJElWQTNSg" />
      ...
      <meta name="keywords" content="Secure Shopping Zahi">
      <meta name="description" content="Secure Shopping Zahi">
      <meta name="author" content="Secure Shopping Zahi">
      ...
      <title>Secure Shopping Zahi</title>
...
<div class="breadcrumb-area mt-10">
        <div class="container">
            <div class="row">
               <div class="col-md-6 col-sm-6">
                    <h1 class="text-uppercase" style="font-size: 1.5rem;">Secure Shopping</h1>
                </div>
                <div class="col-md-6 col-sm-6 hidden">
                    <ul class="breadcrumb pull-right">
                        <li><a href="<?=base_url();?>">Home</a></li>
                        
                         <li class="active"><a href="#"> Secure Shopping</a></li>
                                                                                            </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container bg-white">
            <div class="row p-4">
          <div class="col-12 ">
            <h2 style="box-sizing: border-box; padding: 14px 0px 0px; margin: 0px 0px 16px; text-rendering: optimizelegibility; line-height: 1.2;"><span style="box-sizing: border-box; margin: 0px; outline: 0px; font-family: &quot;Times New Roman&quot;, Times, serif; font-size: 48px; color: rgb(0, 0, 0);">Secure Shopping</span></h2>
