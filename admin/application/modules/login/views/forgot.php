...
<body class="app h-100vh">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 justify-content-center mx-auto text-center">
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-md-12 col-lg-7 pr-0 d-none d-lg-block"> <img src="<?=base_url();?>uploads/login2.jpg" alt="img" class="br-tl-2 br-bl-2 "> </div>
	...
	<?php } ?>
	 ...
	 <form id="login_form" action="<?php echo site_url('login/forgot');?>" method="POST">
	  <div class="row">
	  <div class="col-md-12">
     ...
     <div class="form-footer mt-1"> <button type="submit" class="btn btn-success btn-block">Send</button> </div>
     </form>                                  
									   
     <div class="text-center text-muted mt-3 "> Forget it, <a href="<?php echo base_url('login');?>">send me back</a> to the sign in screen. </div>
                                </div>
                            </div>
                        </div>
                    </div>
