                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="javascript:void(0)" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group"> 
                                        ...
                                        <input type="text" class="form-control" name="blg_title" placeholder="Enter Blog Title" onkeyup="slug_url(this.value,'blg_title_slug')" value="<?php echo $blginfo->blg_title;?>">
                                        <input type="hidden" class="form-control" name="blg_title_slug" id="blg_title_slug" value="<?php echo $blginfo->blg_title_slug;?>"> 
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group"> 
                                        <label>Author Name <span class="red">*</span></label>
                                        <input type="text" class="form-control" name="blg_author" placeholder="Enter Post Author Name" value="<?php echo $blginfo->blg_author_name;?>"> 
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6">
                                    ...
                                    <select name="status" class="form-control pd_brand">
                                        <option value="1" <?php if($blginfo->blg_status=='1'){echo "selected";} ?>>Draft</option>
                                        <option value="0" <?php if($blginfo->blg_status=='0'){echo "selected";} ?>>Published</option>  
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <textarea rows="3" name="description" class="form-control pd_description" id="summernote"><?php echo $blginfo->blg_descriptions?></textarea>
                                </div>
                            </div>
