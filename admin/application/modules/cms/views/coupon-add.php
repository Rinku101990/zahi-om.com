...
<div class="app-content">
            ...
            <div class="col-lg-10 col-xl-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add Coupon</h3> </div>
  ...
  <?php }  $number='CUP'.rand(10,1000000);?>
          ...
          <div class="col-sm-6 col-md-8">
              <div class="form-group">    
    <input type="text" class="form-control" name="cup_code" value="<?=$number;?>" placeholder="Coupon Code"  >                      
                    </div>
                    </div> 
          ...
          <div class="col-sm-6 col-md-8">
                        <div class="form-group">    
    <input type="text" class="form-control" name="cup_name"  placeholder="Coupon Name"  >                      
                    </div>
                    </div> 
 ...
 <div class="col-lg-12 col-md-12">
          ...
          <div class="col-sm-6 col-md-8">
              <div class="form-group">    
    <input type="text" class="form-control" name="cup_min_order" onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))" placeholder="Min. Order Amount"  >                      
                    </div>
                    </div> 
    ...
    <input type="text" class="form-control" name="cup_discount" onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))"  placeholder="Coupon Discount(%)"  >                      
          ...
          <input type="text" name="cup_start_date" class="form-control input-group date" id="sp_start_date" autocomplete="off" placeholder="Start Date " style=" padding-left: 27px;">
           </div>
          ...
          <div class="col-sm-6 col-md-8">
             	<div class="form-group">  
                        	<i class="fa fa-calendar input-icon"></i>                              
          <input type="text" name="cup_end_date" class="form-control input-group date" id="sp_start_date" autocomplete="off" placeholder="End Date " style=" padding-left: 27px;">
           </div>
