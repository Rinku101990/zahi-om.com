       ...
       <!--  Page-header opened -->
        <div class="page-header">
            ...
            <div class="mt-3 mt-lg-0"> <div class="d-flex align-items-center flex-wrap text-nowrap"> 
             ...
             <?php  if($this->login->mst_role=='0' || !empty($permission['order_return_reasons_add'])){ ?>
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="wd-15p sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" >Status</th>
                                                     ...
                                                     <?php  if($this->login->mst_role=='0' || !empty($permission['order_return_reasons_edit']) || !empty($permission['order_return_reasons_delete'])){ ?>  
...
<td align="center" style="width: 83px;"> 
  <?php  if($this->login->mst_role=='0' || !empty($permission['order_return_reasons_edit'])){ ?>
...
<?php } if($this->login->mst_role=='0' || !empty($permission['order_return_reasons_delete'])){ ?>
