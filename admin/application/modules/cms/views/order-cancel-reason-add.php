...
<div class="app-content">
    <div class="section">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Order Cancel Reason</li>
            </ol>
            ...
            <div class="col-lg-10 col-xl-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add Order Cancel Reason</h3> </div>
  ...
  <?php } ?>
          ...
          <div class="col-sm-6 col-md-8">
                        <div class="form-group">    
    <input type="text" class="form-control" name="ocr_title"  placeholder="Reason Title"  >                      
                    </div>
                    </div> 
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">    
                    <textarea class="form-control" name="ocr_description" id="summernote3" ></textarea>
                    </div>
                    </div> 
