       ...
       <!--  Page-header opened -->
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Manage Order Cancel Reasons</li>
            </ol>
            <div class="mt-3 mt-lg-0"> <div class="d-flex align-items-center flex-wrap text-nowrap"> 
             <button type="button" onclick="history.go(-1)" class="btn btn-secondary btn-icon-text mr-2 mb-2 mb-md-0"> <i class="fa fa-arrow-left"></i> Go Back  </button>
             <?php  if($this->login->mst_role=='0' || !empty($permission['order_cancel_reasons_add'])){ ?>
             <a href="<?=base_url('cms/order-cancel-reason-add');?>">
            <button type="button" class="btn btn-primary btn-icon-text mb-2 mb-md-0"> <i class="fe fe-plus "></i> Add Order Cancel Reason</button>
             </a>
           <?php }?>
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Order Cancel Reasons list</div>
...
<div class="alert alert-<?php echo $msg['class'] ?> alert-dismissible fade show" role="alert"> <span class="alert-inner--icon"><i class="fe fe-<?php echo $msg['icon'] ?> "></i></span> <span class="alert-inner--text"><strong><?php echo $msg['type'] ?></strong> <?php echo $msg['message']; ?></span> <button type="button" class="close text-white" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button> </div>
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th class="wd-15p sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" >Status</th>
                                                       <th class="wd-15p sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" >Created</th>
                                                         <?php  if($this->login->mst_role=='0' || !empty($permission['order_cancel_reasons_edit']) || !empty($permission['order_cancel_reasons_delete'])){ ?>
 ...
 <td align="center">
<a href="javascript:void(0);"onclick="javascript:showMyModalSetTitle('Change Status','order_cancel_reason_status/',<?=$list->ocr_id;?>,<?php if($list->ocr_status=='1'){echo'2';}else{echo'1';}?>)">
...
<td align="center" style="width: 83px;"> 
  <?php  if($this->login->mst_role=='0' || !empty($permission['order_cancel_reasons_edit'])){ ?>
<a href="<?=base_url('cms/order-cancel-reason-edit/').encode($list->ocr_id);?>" class="btn btn-info btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit"></i></a>
<?php }
 if($this->login->mst_role=='0' || !empty($permission['order_cancel_reasons_delete'])){ ?>
<a href="javascript:void(0);" onclick="javascript:showMyModalSetTitle('Delete','order_cancel_reason_delete/',<?=$list->ocr_id;?>,'')" class="btn btn-danger btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-trash"></i></a>
<?php }?>
