...
<div class="app-content">
            ...
            <div class="col-lg-10 col-xl-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add Order Return Reason</h3> </div>
  ...
  <?php } ?>
          ...
          <div class="col-sm-6 col-md-8">
                        <div class="form-group">    
    <input type="text" class="form-control" name="tm_name"  placeholder="Name"  >                      
                    </div>
                    </div> 
          ...
          <div class="col-sm-6 col-md-8">
              <div class="form-group">    
    <input type="text" class="form-control" name="tm_designation"  placeholder="Designation"  >                      
                    </div>
                    </div> 
          ...
          <div class="col-sm-6 col-md-8">
            ...
            <input type="file" class="form-control" name="tm_img" id="image_file" onchange="preview_image();" />  
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">    
                    <textarea class="form-control" name="tm_description" id="summernote3" ></textarea>
                    </div>
                    </div> 
