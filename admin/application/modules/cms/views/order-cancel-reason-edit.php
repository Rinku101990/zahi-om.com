...
<div class="app-content">
    <div class="section">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Order Cancel Reason</li>
            </ol>
            <div class="mt-3 mt-lg-0"> <div class="d-flex align-items-center flex-wrap text-nowrap"> 
             <button type="button" onclick="history.go(-1)" class="btn btn-secondary btn-icon-text mr-2 mb-2 mb-md-0"> <i class="fa fa-arrow-left"></i> Go Back  </button>
            <a href="<?=base_url('cms/order-cancel-reasons');?>">
            <button type="button" class="btn btn-primary btn-icon-text mb-2 mb-md-0"> <i class="fe fe-list "></i> List Order Cancel Reasons</button>
             </a>   
            ...
            <div class="col-lg-10 col-xl-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Edit Order Cancel Reason</h3> </div>
  ...
  <?php } ?>
          ...
          <div class="col-sm-6 col-md-8">
                        <div class="form-group">    
    <input type="text" class="form-control" name="ocr_title" value="<?=$order_canecl->ocr_title;?>" placeholder="Reason Title"  >                      
                    </div>
                    </div> 
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">    
                    <textarea class="form-control" name="ocr_description" id="summernote3" ><?=$order_canecl->ocr_description;?></textarea>
                    </div>
                    </div> 
