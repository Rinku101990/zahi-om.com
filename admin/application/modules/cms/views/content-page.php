       ...
       <!--  Page-header opened -->
        <div class="page-header">
            ...
            <div class="mt-3 mt-lg-0"> <div class="d-flex align-items-center flex-wrap text-nowrap"> 
             ...
             <?php if($this->login->mst_role=='0' || !empty($permission['content_pages_add'])){?>
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="wd-15p sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" >Status</th>
                                                        <th class="wd-20p sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Price: activate to sort column ascending" style="width: 90px;">Updated</th>
                                                            <?php if($this->login->mst_role=='0' || !empty($permission['content_pages_edit']) || !empty($permission['content_pages_delete'])){?>
...
<td align="center"> 
<?=date('d-M-Y',strtotime($list->pg_updated));?>
 </td>
    <?php if($this->login->mst_role=='0' || !empty($permission['content_pages_edit']) || !empty($permission['content_pages_delete'])){?>
<td align="center"> 
    <?php if($this->login->mst_role=='0' || !empty($permission['content_pages_edit'])){?>
...
<?php }?>
<!--   <?php if($this->login->mst_role=='0' || !empty($permission['content_pages_delete'])){?>-->
