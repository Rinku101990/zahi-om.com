...
<div class="app-content">
            ...
            <div class="col-lg-10 col-xl-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add Banner</h3> </div>
  ...
  <?php } ?>
          ...
          <div class="col-sm-6 col-md-8">
                        <div class="form-group">    
    <input type="text" class="form-control" name="slr_name"  placeholder="Banner Name"  >                      
                    </div>
                    </div> 
          ...
          <div class="col-sm-6 col-md-8">
                        <div class="form-group">    
    <input type="text" class="form-control" name="slr_order"  onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))"  placeholder="Banner Order No."  >                      
                    </div>
                    </div> 
          ...
          <div class="col-sm-6 col-md-8">
                        <div class="form-group">    
    <input type="url" class="form-control" name="slr_url" placeholder="Banner Url"  >                      
                    </div>
                    </div> 
          ...
          <div class="col-sm-6 col-md-8">
                        <div class="form-group">    
    <input type="text" class="form-control" name="slr_cost"  onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))"  placeholder="Banner Pormotion Cost"  >                      
                    </div>
                    </div> 
