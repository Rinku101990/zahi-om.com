    ...
    <div class="section">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Size Add</li>
            </ol>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card mb-xl-0">
            <div class="card-header">
                <h3 class="card-title">Size Add</h3> </div>
            <div class="card-body">
...
<div class="alert alert-<?php echo $msg['class'] ?> alert-dismissible fade show" role="alert">  <span class="alert-inner--text"><strong><?php echo $msg['type'] ?></strong> <?php echo $msg['message']; ?></span> <button type="button" class="close text-white" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button> </div>
	...
	<form  method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">                          
                       <input type="number" class="form-control" name="sz_shoulder" placeholder="Shoulder" required="">
                       </div>
                    </div> 
                </div>
                 <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">                          
                       <input type="number" class="form-control" name="sz_bust" placeholder="Bust" required="">
                       </div>
                    </div> 
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">                          
                       <input type="number" class="form-control" name="sz_waist" placeholder="Waist" required="">
                       </div>
                    </div> 
                </div>
                 <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">                          
                       <input type="number" class="form-control" name="sz_hips" placeholder="Hips" required="">
                       </div>
                    </div> 
                </div>
                 <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">                          
                       <input type="number" class="form-control" name="sz_length" placeholder="Length" required="">
                       </div>
                    </div> 
                </div>
                <!-- <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">                          
                       <input type="text" class="form-control" name="sz_name_ar" placeholder="Size Name Ar" dir="rtl" style="text-align: right;
direction:RTL;" required="">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">                          
                       <input type="file" class="form-control" name="sz_img" placeholder="Size Image Upload" accept="image/*" required=""> </div>
                    </div> 
