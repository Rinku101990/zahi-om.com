      ...
      <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
         <div class="card">
            <div class="card-header">
               <h3 class="card-title">Edit Special Price Detail</h3>
            </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="row">
                           ...
                           <div class="col-sm-6 col-md-8">
                                <div class="form-group">                          
                                    <input type="text" name="sp_vnd_id" value="<?=$vendorInfo;?>" class="form-control"  placeholder="Product Name" readonly>  
                                </div>
                           </div>
                        </div>
                     </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-8">
                                <div class="form-group">                          
                                    <input type="text" name="sp_pid" value="<?=getProductName($special_price->sp_pid);?>" class="form-control"  placeholder="Product Name" readonly>  
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                     ...
                     <div class="col-lg-6 col-md-12">
                        <div class="row">
                           ...
                           <div class="col-sm-6 col-md-8">
                              <div class="form-group">                          
                                 <input type="text" class="form-control" name="sp_special_price" value="<?=$special_price->sp_special_price;?>" placeholder="Special Price" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57)))" >  
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-6 col-md-8">
                              <div class="form-group">   
                                 ...
                                 <input type="text" class="form-control input-group date" name="sp_start_date" value="<?=date('Y-m-d',strtotime($special_price->sp_start_date));?>" placeholder="Start Date "  style=" padding-left: 28px;">  
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6 col-md-12">
                        <div class="row">
                           ...
                           <div class="col-sm-6 col-md-8">
                              <div class="form-group">   
                                 <i class="fa fa-calendar input-icon"></i>                       
                                 <input type="text" class="form-control input-group date" name="sp_end_date" value="<?=date('Y-m-d',strtotime($special_price->sp_end_date));?>" placeholder="End Date" style=" padding-left: 28px;" > 
                              </div>
                           </div>
                        </div>
                     </div>
