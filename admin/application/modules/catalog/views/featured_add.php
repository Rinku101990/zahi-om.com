...
<div class="app-content">
    <div class="section">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Featured Detail</li>
            </ol>
            <div class="mt-3 mt-lg-0"> <div class="d-flex align-items-center flex-wrap text-nowrap"> 
             <button type="button" onclick="history.go(-1)" class="btn btn-secondary btn-icon-text mr-2 mb-2 mb-md-0"> <i class="fa fa-arrow-left"></i> Go Back  </button>
            <a href="<?=base_url('catalog/featured');?>">
            <button type="button" class="btn btn-primary btn-icon-text mb-2 mb-md-0"> <i class="fe fe-list "></i> List Featured </button>
             </a>   
            ...
            <div class="col-lg-10 col-xl-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add Featured</h3> </div>
	<form id="edit_featured" action="" method="POST">
       <div class="card-body">
	...
	<?php } ?>
					...
					<div class="col-sm-6 col-md-9">
                        <div class="form-group">                          
                   <select name="product[]" class="form-control select2 select2-selection--single w-100 select2-hidden-accessible " data-placeholder="Select Product Name" tabindex="-1" aria-hidden="true" multiple="">
