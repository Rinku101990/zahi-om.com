...
<div class="row">
 ...
 <label>Selling Price [<?=currency($this->website->web_currency);?>] <span class="red">*</span></label>
 <input type="text" name="int_selleing_price[]" id="int_selleing_price2" class="form-control int_selleing_price" readonly=""  >
<span id="selleing_price"></span>
 </div>
    <div class="col-sm-3 col-md-3">
 <label>Available Quantity <span class="red">*</span></label>
...
<div class="col-sm-3 col-md-3">
    ...
    <a href="javascript:void(0);" class="btn btn-default add_Dimensions " title="Add field" onclick="add_Dimensions(this)" style="margin-bottom:20px"><i class="fa fa-plus"></i> Add</a></div>
</div>
...
<div class="col-sm-2 col-md-2">
    <label style="width: 100%">&nbsp;</label>
    <a href="javascript:void(0);" class="btn btn-default add_getsize " title="Add field" onclick="add_getsize(this)" style="margin-bottom:20px"><i class="fa fa-plus"></i> Add</a></div>
</div>
