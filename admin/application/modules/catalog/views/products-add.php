      ...
      <div class="col-lg-10 col-xl-12 col-md-12 col-sm-12">
         <div class="card">
            <div class="card-header" style="padding-bottom: 0px;">
               <h3 class="card-title"><span>Select Product Category</span></h3>
            </div>
            <div class="card-body">
               <div class="row">
                        ...
                        <div id="English" class="tab-pane active fade in">
                           <div class="row">
                              ...
                              <div class="col-sm-6 col-md-6">
                                 ...
                                 <input type="number" name="p_selling_price" onkeyup="selling_price(this.value,'int_selleing_price')" class="form-control pd_selling_price" placeholder="Selling Price" >
                                 <span id="pd_price"></span>
                              </div>
                              <!-- <div class="col-sm-6 col-md-6">
                                 <label>Special Price [<?=currency($this->website->web_currency);?>] <span class="red">*</span></label>
                                 <input type="number" name="sp_special_price" placeholder="Special Price" onkeypress="return (event.charCode !=8 &amp;&amp; event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 &amp;&amp; event.charCode <= 57)))" class="form-control"  >
                              </div> -->
                              <div class="col-sm-6 col-md-6">
                                 <label>Sale Price [<?=currency($this->website->web_currency);?>] </label>
                                 <input type="number" name="p_sp_special_price1"  class="form-control pd_sp_special_price1"  onkeypress="return special_price1(event);">
                           ...
                           <div class="row" style=" margin-top: 20px;">
                              ...
                              <div class="col-sm-6 col-md-6">
                                 ...
                                 <div class="input-group date">
                                    <input type="text" name="p_from"  class="form-control pd_from" autocomplete="off"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                 </div>
                              </div>
                              <div class="col-sm-6 col-md-6">
                                 <label>To Date</label>
                                 <div class="input-group date">
                                    <input type="text" name="p_to"  class="form-control pd_to" autocomplete="off"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                 </div>
                              </div>
                           </div>
                           <div class="row" id='cloth-product' style=" margin-top: 20px;">
                              <div class="col-sm-6 col-md-6">
                                 <label>Fabric <span class="red"></span></label>
                                 <input type="text" name="p_fabric" class="form-control pd_fabric"  />
                              </div>
                              <div class="col-sm-6 col-md-6">
                                 <label>&nbsp; <span class="red"></span></label><br/>
                                 Belt Include : <input type="checkbox" name="p_belt" value="1" /><br>
                                 Scarf Include : <input type="checkbox" name="p_sarf" value="1"/>
                              </div>
                           </div>
                           <div class="row" id='other-product' style=" margin-top: 20px;">
                              <div class="col-sm-6 col-md-6">
                           ...
                           <div class="row" style=" margin-top: 20px;">
                              ...
                              <div class="col-sm-4 col-md-4">
                                 ...
                                 <div class="custom-controls-stacked"> 
                                    ...
                                    <label class="custom-control custom-radio" style="display: inline-flex;"> <input type="radio" class="custom-control-input" name="p_feature" value="1"> <span class="custom-control-label">Yes</span> </label>
                                 </div>
                              ...
                              <div class="col-sm-4 col-md-4">
                                 ...
                                 <div class="custom-controls-stacked"> 
                                    ...
                                    <label class="custom-control custom-radio" style="display: inline-flex;"> <input type="radio" class="custom-control-input" name="p_trending" value="1"> <span class="custom-control-label">Yes</span> </label>
                                 </div>
                              ...
                              <div class="col-sm-4 col-md-4">
                                 ...
                                 <div class="custom-controls-stacked"> 
                                    ...
                                    <label class="custom-control custom-radio" style="display: inline-flex;"> <input type="radio" class="custom-control-input" name="p_eid" value="1"> <span class="custom-control-label">Yes</span> </label>
                                 </div>
                                 <span id="p_eid"></span>
                              </div>
               ...
               <div class="account_login_form">
                  ...
                  <form id="CategoryProductForm"  method="post" >
                     ...
                     <div class="save_button primary_btn default_button">
                        ...
                        <span id="CategoryButton1" style="display:none">
                        <button type="button" class="btn btn-primary btn2 CategoryProduct_Save" url="<?=base_url();?>"><i class="fa fa-save"></i> Save</button>
                        </span>
                        <button type="button" class="btn btn-secondary btn2 general_product_prev"><i class="fa fa-angle-double-left"></i> Prev </button>
                        <span id="CategoryNext">
                        <button type="button" class="btn btn-secondary btn2 " id="product_link_next" > Next <i class="fa fa-angle-double-right"></i></button>
                        </span>
                        <span id="CategoryNext1" style="display:none">
                        <button type="button" class="btn btn-secondary btn2 " id="productlink_next" > Next <i class="fa fa-angle-double-right"></i></button>
                        </span>
                     </div>
                  </form>
               </div>
                  ...
                  <form id="OptionGroupProductForm"  method="post" >
                     ...
                     <div class="row">
                        <div class="col-sm-6 col-md-6">
                           ...
                           <select name="p_option_group[]" id="p_option_group" class="form-control select2 w-100 select2-hidden-accessible p_option" multiple="" data-placeholder="Select Option Groups" tabindex="-1" aria-hidden="true">
                              <option value="">Select</option>
                              <?php /*if(!empty($option)){
               ...
               <div class="account_login_form">
                  ...
                  <form id="InventoryProductCLothForm"  method="post" >
                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-2 col-md-2">
                           <input type="radio" name="custom" value="1" class="int_custom sizechecked" checked=""> Custom<br/>
                           <input type="radio" name="custom" value="2" class="int_custom sizechecked" > Size <span class="getsize"></span>
                        </div>
                        <span id="Dimensions_add" style="width: 100%; margin-top: 20px;">
                           <div class="row">
                              <div class="col-sm-3 col-md-3">
                                 <label>Selling Price [<?=currency($this->website->web_currency);?>] <span class="red">*</span></label>
                                 <input type="text" name="cust_selleing_price[]" id="int_selleing_price2" class="form-control int_selleing_price" readonly=""  >
                                 <span id="selleing_price"></span>
                              </div>
                              <div class="col-sm-3 col-md-3">
                                 <label>Available Quantity <span class="red">*</span></label>
                                 <input type="text" name="cust_available_qty[]" value="1" onkeypress="return available(event);" class="form-control int_available_qty">
                                 <span id="available_qty"></span>
                              </div>
                              <div class="col-sm-3 col-md-3">
                                 ...
                                 <select name="cust_color[]" class="form-control int_color">
                                    ...
                                    <?php foreach(explode(', ',$option[0]->opt_value) as $clr){
                                       echo'<option value="'.$clr.'">'.$clr.'</option>';
                                       }?>
                                 </select>
                           ...
                           <div class="row">
                              ...
                              <div class="col-sm-5 col-md-5">
                                 <input type="checkbox" name="length" value="1"  > Length<br/>
                                 <input type="checkbox" name="waist" value="1"> Waist  <br/>
                                 <input type="checkbox" name="shoulder" value="1"  > Shoulder<br/>
                                 <input type="checkbox" name="hips" value="1"> Hips  <br/>
                                 <input type="checkbox" name="sleeve_length" value="1"  > Sleeve Length<br/>
                                 <input type="checkbox" name="neck" value="1"> Sleeve form the neck  <br/>
                                 <input type="checkbox" name="chest" value="1"> Chest  <br/>
                              </div>
                           </div>
                           <br/>
                        </span>
                        <span id="Size_add" style="width: 100%; margin-top: 20px; display: none;">
                           <div class="row">
                              <div class="col-sm-2 col-md-2">
                                 <label>Selling Price [<?=currency($this->website->web_currency);?>] <span class="red">*</span></label>
                                 <input type="text" name="int_selleing_price[]" id="int_selleing_price3" class="form-control int_selleing_price" readonly=""  >
                                 <span id="selleing_price"></span>
                              </div>
                              <div class="col-sm-2 col-md-2">
                                 <label>Available Quantity <span class="red">*</span></label>
                              ...
                              <span class="SizeColumn" style=" width: 16.66666667%;"></span>
                              <div class="col-sm-2 col-md-2">
                                 <label>Size <span class="red">*</span></label>
                     ...
                     <br>
                     <div class="save_button primary_btn default_button">
                        <button type="button" class="btn btn-primary btn2 InventoryProduct_cloth" url="<?=base_url();?>"><i class="fa fa-save"></i> Save</button>
               ...
               <div class="account_login_form">
                  ...
                  <form id="WarrantyProductForm"  method="post" >
                     ...
                     <div class="save_button primary_btn default_button">
                        ...
                        <span id="Warranty_prev">
                        <button type="button" class="btn btn-secondary btn2 Warranty_prev" ><i class="fa fa-angle-double-left"></i> Prev </button>
                        </span>
                        <span id="Warranty_prev1">
                        <button type="button" class="btn btn-secondary btn2 WarrantyPrev" ><i class="fa fa-angle-double-left"></i> Prev </button>
                        </span>
                           ...
                           <table class="table table-striped table-bordered dataTable " >
                              ...
                              <tbody>
                                 ...
                                 <tr role="row" >
                                    ...
                                    <td align="center">
                                       <div class="form-group"> 
                                          <label class="custom-switch"> <input type="checkbox" name="p_return_policy[]" class="custom-switch-input return_policy" value="<?=$policy_value->pp_id;?>"  > <span class="custom-switch-indicator"></span> </label> 
                                       </div>
                                    </td>
                                 </tr>
                                 <?php }}}?>
               ...
               <div class="account_login_form">
                  ...
                  <form id="SpecialPriceProductForm"  method="post" >
                     ...
                     <div class="row">
                        <div class="col-sm-6 col-md-6">
                           <label>Special Price [<?=currency($this->website->web_currency);?>] <span class="red">*</span></label>
                           <input type="text" name="special_price" class="form-control special_price"  >
