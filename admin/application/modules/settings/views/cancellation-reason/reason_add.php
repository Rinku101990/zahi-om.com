                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                ...
                                <?php }?>
                                <form action="<?php echo site_url('settings/addReason');?>" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-9">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="cr_name" placeholder="Enter Cancellation Reason"> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
