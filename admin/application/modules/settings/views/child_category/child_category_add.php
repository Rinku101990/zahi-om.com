    ...
    <div class="section">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Child Category Add</li>
            </ol>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card mb-xl-0">
            <div class="card-header">
                <h3 class="card-title">Child Category Add</h3> </div>
            <div class="card-body">
  ...
  <option value="">--Select--</option>
	...
	<?php }}}}}?>
                 ...
                 <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">                          
                       <input type="text" class="form-control" name="child_name" placeholder="Child Category name (En)" onkeyup="slug_url(this.value,'child_slug')">
                       <input type="hidden" name="child_slug" id="child_slug" class="form-control form-control-sm"  />  </div>
                    </div> 
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">                          
                       <input type="text" class="form-control" name="child_name_ar" placeholder="Child Category name Ar" dir="rtl" style="text-align: right;direction:RTL;"> </div>
                    </div> 
