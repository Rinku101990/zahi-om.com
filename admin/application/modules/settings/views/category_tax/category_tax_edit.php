    ...
    <div class="section">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Category Tax Edit</li>
            </ol>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card mb-xl-0">
            <div class="card-header">
                <h3 class="card-title">Category Tax Edit</h3> </div>
            <div class="card-body">
	...
	<form id="category_tax_add" method="post">
         <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                       ...
                       <option value="<?php echo  $txt_id=$txt_value->txt_id;?>" <?php if($tax_info->txt_name==$txt_id)echo'selected';?>><?=$txt_value->txt_name;?></option>
                   <?php }}?>
	 ...
	 <div class="row">
					...
					<div class="col-sm-6 col-md-8">
					 ...
					 <option value="<?php echo $ID=$cate->cate_id;?>" <?php if($tax_info->cate_id==$ID)echo'selected';?> ><?=$cate->cate_name;?></option>
					   <?php }}?>
