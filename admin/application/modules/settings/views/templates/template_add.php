    ...
    <div class="section">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Template Add</li>
            </ol>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card mb-xl-0">
            <div class="card-header">
                <h3 class="card-title">Template Add</h3> </div>
            <div class="card-body">
...
<br>
				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-9">
                        <div class="form-group">                          
                       <input type="text" class="form-control" name="tp_name" placeholder="Template Name" /> 
					  </div>
                    </div> 
				 ...
				 <div class="row">
					...
					<div class="col-sm-6 col-md-9">
                        <div class="form-group">                          
                       <input type="text" class="form-control" name="tp_subject" placeholder="Template Subject" /> 
					  </div>
                    </div> 
					...
					<div class="col-sm-6 col-md-9">
                        <div class="form-group">                          
                       <textarea class="form-control" name="tp_body" id="summernote" placeholder="Template Subject" ></textarea> 
					  </div>
                    </div> 
