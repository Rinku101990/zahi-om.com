    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card mb-xl-0">
            <div class="card-header">
                <h3 class="card-title">Translate Edit</h3> </div>
            <div class="card-body">
	...
	<form id="brand_edit" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">                          
                       <input type="text" class="form-control" value="<?=$trans_info->name;?>" name="name" placeholder="Name" required /> </div>
                    </div> 
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">                          
                       <input type="text" class="form-control" value="<?=$trans_info->name_ar;?>" name="name_ar" placeholder="Name" dir="rtl" style="text-align: right;direction:RTL;"> </div>
                    </div> 
