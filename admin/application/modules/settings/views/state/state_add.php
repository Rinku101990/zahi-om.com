    ...
    <div class="section">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">State Add</li>
            </ol>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card mb-xl-0">
            <div class="card-header">
                <h3 class="card-title">State Add</h3> </div>
            <div class="card-body">
	...
	<form id="state_add" method="post">
	 <div class="row">
					...
					<div class="col-sm-6 col-md-8">
					   ...
					   echo'<option value="'.$cate->cnt_id.'" >'.$cate->cnt_name.'</option>';}}?>
                ...
                <div class="row">
					...
					<div class="col-sm-6 col-md-8">
                        <div class="form-group">                          
                       <input type="text" class="form-control" name="st_name" placeholder="State Name"> </div>
                    </div> 
