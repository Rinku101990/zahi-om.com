...
//            $registrationIds = array($out1);
        ...
        //    print_r($registrationIds);//die;
			...
			$serverKey = 'AAAA7ecZek0:APA91bExGDt5_nbHUV2xLEHDgCse3HTnmhxpd-DWdwcmh4jNi08gjMveWIg35MJk-7LodgX0bawRHEYulyeLbimlQm8EaaT1ngqV4fIvw7wIyESe4iInA5L-JZxDHndWvjghdVeDYk2w';
	...
	public function send_android()
	{
		...
		if($REQUESTMETHOD== "POST"){   
			...
			/*-- Check User --*/
			$deviceType = $this->input->post('devicetype');
 			$out1 = $this->Notification->check_device_token_android($deviceType,$this->users);
			foreach($out1 as $out2)
			{
