    ...
    <div class="section">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Notification Template(Android)</li>
            </ol>
            ...
            <div class="col-lg-10 col-xl-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Notification Template(Android)</h3> </div>
                        <form id="edit_special_price" action="<?php echo site_url('notifications/send_android');?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
