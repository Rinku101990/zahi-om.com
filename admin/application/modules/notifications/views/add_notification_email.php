    ...
    <div class="section">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Notification Template(Email)</li>
            </ol>
            <div class="mt-3 mt-lg-0">
                <div class="d-flex align-items-center flex-wrap text-nowrap">
                    <button type="button" onclick="history.go(-1)" class="btn btn-secondary btn-icon-text mr-2 mb-2 mb-md-0"> <i class="fa fa-arrow-left"></i> Go Back </button>
                    <!--<a href="<?=base_url('notifications/android');?>">-->
                    <!--    <button type="button" class="btn btn-primary btn-icon-text mb-2 mb-md-0"> <i class="fe fe-list"></i>Template List</button>-->
                    <!--</a>-->
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-10 col-xl-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Notification Template(Email)</h3> </div>
                        <form id="edit_special_price" action="<?php echo site_url('notifications/email');?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label" style="text-align:right">Customer<span class="text-red">*</span></label>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-9">
                                                <div class="form-group">
                                                    <select class="form-control select2" name="usr_email[]"  required="required" multiple>
                                                        <option value="">Select</option>
                                                        <?php foreach($user as $uval){?>
                                                        <option value="<?=$uval->usr_email;?>"><?=$uval->usr_email;?></option>
                                                        <?php }?>
                                                        </select> 
                                                </div>
                                            </div>
