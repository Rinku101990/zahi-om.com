                            ...
                            <table class="table table-bordered table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="<?php echo $ordValue->sl_img;?>" style="width: 50px;height: 60px;object-fit: contain;"></td>
                                        <td>
                                            <p class="font-w600 mb-1"><?php echo $ordValue->sl_name;?></p>
                                        </td>
                                         <td class="text-center"><img src="<?php echo $ordValue->fb_img;?>" style="width: 50px;height: 60px;object-fit: contain;"></td>
                                         <td class="text-center"><img src="<?php echo $ordValue->cl_img;?>" style="width: 50px;height: 60px;object-fit: contain;"></td>
                                          <td class="text-center"><p style=" font-size: 12px;font-weight: 600;">
                    Shoulder :  <?=$ordValue->shoulder;?> Inch<br/>
                    Bust :  <?=$ordValue->bust;?> Inch<br/>
                    Waist :  <?=$ordValue->waist;?> Inch<br/>
                    Hips :  <?=$ordValue->hips;?> Inch<br/>
                    Length :  <?=$ordValue->length;?> Inch</p></td>
                                         
                                          <td class="text-right"><?=currency($this->website->web_currency);?><?php echo $ordValue->sl_price;?></td>
                                        <td class="text-center"><?php echo $ordValue->qty;?></td>
                                       
                                        <td class="text-right"><?=currency($this->website->web_currency);?><?php echo $ordValue->sl_price*$ordValue->qty;?></td>
                                    </tr>
                                    <?php } ?>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="9" class="text-right">
                                            ...
                                            <?php if($ordInfo->order_status!="Waiting"){ ?>
                                                <a href="<?php echo site_url('orders/design_update/'.$ordInfo->ord_id.'/'.encode("Waiting"));?>" class="btn btn-primary btn-sm"><i class="icon icon-cup"></i> Waiting</a>
                                            <?php } ?>
                                            
                                            <?php if($ordInfo->order_status!="InProcess"){ ?>
                                                <a href="<?php echo site_url('orders/design_update/'.$ordInfo->ord_id.'/'.encode("InProcess"));?>" class="btn btn-success btn-sm"><i class="icon icon-hourglass"></i> InProcess</a>
                                            <?php } ?>
                                            
                                            <?php if($ordInfo->order_status!="Dispatched"){ ?>
                                                <a href="<?php echo site_url('orders/design_update/'.$ordInfo->ord_id.'/'.encode("Dispatched"));?>" class="btn btn-info btn-sm"><i class="icon icon-plane"></i> Dispatched</a>
                                            <?php } ?>
                                            
                                            
                                            <?php if($ordInfo->order_status!="Delivered"){ ?>
                                                <a href="<?php echo site_url('orders/design_update/'.$ordInfo->ord_id.'/'.encode("Delivered"));?>" class="btn btn-warning btn-sm"><i class="icon icon-like"></i> Delivered</a>
                                            <?php } ?>
