                    ...
                    <div class="card-body">
                        <div class="inbox-body">
                            <div class="mail-option">
                                ...
                                <div class="btn-group">
                                    <a data-original-title="Refresh" data-placement="top" data-toggle="dropdown" style="color: #000;" href="javascript:void(0)" data-href="<?php echo site_url('mails/sent')?>" class="btn mini tooltips pageReload"> <i class="fa fa-refresh"></i> </a>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-inbox table-hover table-vcenter mail-body text-nowrap">
                                    <tbody>
                                        <?php if(!empty($SentList)){ foreach($SentList as $slist){ ?>
                                            <tr class="unread">
