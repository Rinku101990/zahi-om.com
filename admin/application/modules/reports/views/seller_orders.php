    ...
    <div class="section">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Manage Seller Orders</li>
            </ol>
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Seller Orders List</div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="example" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="example_info">
                                            <thead>
                                                <tr role="row">
                                                    <th class="w-15p sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Product name: activate to sort column descending">Inv No</th>
                                                    ...
                                                    <th class="wd-15p sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending">Customer</th>
                                            ...
                                            <tbody>
                                                <tr role="row">
                                                    ...
                                                    <td align="center"><span class="badge badge-danger-light badge-md">Failed</span></td>
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <td align="center"><span class="badge badge-info-light badge-md">Pending</span></td>
                                                    <td align="center">31 Dec 2019</td>
                                                    <td align="center">
                                                        <a href="<?php echo site_url('orders/invoice');?>" class="btn btn-info btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="View"><i class="fa fa-eye"></i></a>
                                                    </td>
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <td align="center"><span class="badge badge-success-light badge-md">Success</span></td>
                                                    <td align="center">31 Dec 2019</td>
                                                    <td align="center">
                                                        <a href="<?php echo site_url('orders/invoice');?>" class="btn btn-info btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="View"><i class="fa fa-eye"></i></a>
                                                    </td>
