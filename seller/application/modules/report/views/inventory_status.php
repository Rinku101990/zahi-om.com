...
<h5 class="cards-title ">Products Inventory List</h5>
<hr>
 <div class="">
                            ...
                            <table id="example" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="example_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="wd-15p sorting">Stock Available(a)</th>
                                        <th class="wd-15p sorting" >Stock On Order</th>
                                        <th class="wd-15p sorting" >Unit Price(b)</th>
                                         <th class="wd-15p sorting" >Total Value
(a*b)</th>
                                ...
                                <tbody>
                                   <?php $i=1; if(!empty($product_inventory)){
                                    foreach ($product_inventory as $key => $pi_list) {

                                   ?>                                   
                                    <tr role="row" class="odd">
                                        <td class="sorting_1" align="center"><?=$i;$i++;?>.</td>
                                        <td align="center"> <?=$pi_list->p_name;?>
                                        </td>                                   
                                        <td align="center"> <?=$pi_list->brd_name;?></td>
                                        <td align="center"> <?=$pi_list->p_model;?></td>
                                         <td align="center"> <?=$pi_list->qty;?></td>
                                         <td align="center"> <?=$pi_list->qty;?></td>
