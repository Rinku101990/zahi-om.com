...
span.select2.select2-container.select2-container--default {
    ...
    z-index: 2;
      ...
      <a href="<?=base_url();?>"><i class="fa fa-home"></i></a>
                                ...
                                <span> Manage Products Comments & Reviews</span>
                            </div>
...
<h5 class="cards-title ">Comments & Reviews List</h5>
<hr>
 <div class="">
                            ...
                            <table id="example" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="example_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="wd-15p sorting" >Reviews</th>
                                        <th class="wd-15p sorting" >Comments</th>
                                     
                                       
                                    </tr>
                                </thead>
                                <tbody>
                                   <?php $i=1; if(!empty($comment_reviews)){
                                    foreach ($comment_reviews as $key => $cr_list) {

                                   ?>                                   
                                    <tr role="row" class="odd">
                                        <td class="sorting_1" align="center"><?=$i;$i++;?>.</td>
                                        <td align="center"> <?=$cr_list->p_name;?>
                                        </td>                                   
                                        <td align="center"> <?=$cr_list->brd_name;?></td>
                                        <td align="center"> <?=$cr_list->p_model;?></td>
                                         <td align="center"> <?=reviews($cr_list->p_id)->star;?> Reviews<br/>
                                            <?=reviews($cr_list->p_id)->user;?> User</td>
                                        
                                          <td align="center">
                                            <?=comments($cr_list->p_id);?> Comments</td>
