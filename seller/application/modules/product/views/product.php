...
<a href="<?=base_url('product/add');?>"><button class="btn_submit" name="btn_submit"><i class="fa fa-plus "></i> Add Product</button></a>
	                                                    </div>
                                </div>
...
<div class="alert alert-<?php echo $msg['class'] ?> alert-dismissible fade show" role="alert"> <span class="alert-inner--icon"><i class="fe fe-<?php echo $msg['icon'] ?> "></i></span> <span class="alert-inner--text"><strong><?php echo $msg['type'] ?></strong> <?php echo $msg['message']; ?></span> <button type="button" class="close text-white" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button> </div>
 ...
 <div class="table-responsive product-datatable">
                                   ...
                                   <?php $i=1; if(!empty($product)){
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td align="center" style="width: 120px;">
                                            ...
                                            <a href="<?=base_url('product/product-edit/').encode($pro_list->p_id);?>" class="btn btn-info btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit"></i></a>
    ...
    <a href="javascript:void(0);" onclick="javascript:showMyModalSetTitle('Delete','product/product_delete/',<?=$pro_list->p_id;?>,'')" class="btn btn-danger btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php }}?>
