...
span.select2.select2-container.select2-container--default {
    ...
    z-index: 2;
	  ...
	  <a href="<?=base_url();?>"><i class="fa fa-home"></i></a>
	                            ...
	                            <span> Manage Special Price</span>
	                        </div>
	                 ...
	                 <div class="col-sm-12 col-md-9 col-lg-9">
	                    ...
	                    <div class="breadcrumb_content">
	                        ...
	                        <div class="breadcrumb_title pull-l">
	                            <h3>Manage Special Price</h3>
	                        </div>
					<div class="action btn-group-scroll pull-right">
                        
                        <div class="save_button primary_btn default_button">
<a href="javascript:void(0);" class="special_price_add"><button class="btn_submit" name="btn_submit"><i class="fa fa-plus "></i> Add Special Price</button></a>
	                                                    </div>
                                </div>
...
<div class="row">
    ...
    <div class="col-md-12 special_add" style="display: none" >
<h5 class="cards-title ">Add Special Price</h5>
<hr>
 
        <div class="row">
            <div class="col-sm-12">
                <form id="SpecialPriceForm" action="<?=base_url('promotion/special_price_save');?>" method="post">
      <div class="row">
            <div class="col-sm-6 col-md-6">
               <div class="form-group ">
                        <label class="form-control-label">Product Name <span class="text-red">*</span> </label>
      <select name="sp_pid" class="form-control select2 select2-selection--single w-100 select2-hidden-accessible " data-placeholder="Select Product Name" tabindex="-1" aria-hidden="true">
   ...
   <div class="col-sm-6 col-md-6">
       ...
       <input type="number" class="form-control" name="sp_special_price" id="sp_special_price" Placeholder="Enter Special Price" >
                    </div></div>
                    <div class="col-sm-6 col-md-6">
                       <div class="form-group">
          ...
          <input type="text" name="sp_start_date" class="form-control input-group date" id="sp_start_date" autocomplete="off" style=" padding-left: 28px;" >
        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                    <div class="form-group">
          ...
          <input type="text" name="sp_end_date" class="form-control input-group date" id="sp_end_date"  autocomplete="off" style=" padding-left: 28px;" >
        </div>
                    </div></div>
...
<h5 class="cards-title ">List Special Price</h5>
<hr>
 <div class="">
                                ...
                                <tbody>
                                   <?php $i=1; if(!empty($special_price)){
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td align="center">
                                         <a href="javascript:void(0);" onclick="javascript:showMyModalSetTitle('Change Status','special_price_status/',<?=$sp_list->sp_id;?>,<?=$action;?>)">
